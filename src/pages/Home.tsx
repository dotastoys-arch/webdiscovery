  ...
  <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20 overflow-hidden">
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <Link to="/contact" className="w-full sm:w-auto bg-white text-black px-8 py-4 rounded-full font-bold text-lg flex items-center justify-center gap-2 hover:scale-105 transition-transform group">
  ...
  <section id="tarief" className="py-32 px-6 relative overflow-hidden">
    <div className="max-w-3xl mx-auto text-center">
      ...
      <div className="mt-16 p-12 glass rounded-[40px] relative">
        ...
        <Link to="/contact" className="w-full bg-white text-black py-6 rounded-2xl font-bold text-xl hover:scale-[1.02] transition-transform flex items-center justify-center">
