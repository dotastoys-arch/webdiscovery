  ...
  return (
    <div className="pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-serif italic mb-12 text-brand-text">Privacy Beleid</h1>
          ...
          <div className="space-y-8 text-brand-muted leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-text mb-4">Gebruik van persoonsgegevens</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-text mb-4">Communicatie</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-text mb-4">Derden</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-text mb-4">Vragen en feedback</h2>
